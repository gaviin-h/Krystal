...
function Article({ article, navigation, setCurrentArticle, status}) {
  ...
  return (
    ...
    <TouchableOpacity 
      ...
      <ImageBackground source={image} resizeMode="cover" style={{ backgroundColor: {article.status}, borderRadius: 6, borderColor:'gray', borderWidth: 1}}  imageStyle={{ borderRadius: 6 ,borderColor: 'gray', opacity: 0.5}}>
